...
from datasets.eval_dataset_text import EvalDatasetText as EvalDataset
...
from utils import collate_fn_eval_text
...
class Evaluator:
    def __init__(self):
        ...
        self.test_dataset = EvalDataset(self.raw_data, self.knowledge_data, 'test')
        self.test_data_loader = DataLoader(self.test_dataset, batch_size=TEST_BATCH_SIZE,
                                           shuffle=False, collate_fn=collate_fn_eval_text,
    ...
    def eval(self):
        ...
        log_writer = open(DUMP_DIR / 'check_points_mhred1.0_full_neg_img1000.log', 'w')
        ...
        with torch.no_grad():
            ...
            for batch_id, data in enumerate(tqdm(self.test_data_loader)):
                ...
                dialog_words, dialog_images, dialog_masks, num_pos_products, products = data
