...
class EvalDatasetText(BaseDataset):
    ...
    def __getitem__(self, index: int):
        ...
        for image in selected_images:
            ...
            if image_file.is_file():
                try:
                    ...
                    image = EvalDatasetText.transform(image)
                except OSError:
                    image = None
            else:
                image = None
            if image is None:
                image = EvalDatasetText.EMPTY_IMAGE
        ...
        return indexed_dialog.words, indexed_dialog.images, indexed_dialog.masks, \
            (len(pos_images), pad_len), (images, styletips, celebrities, attributes)
